...
export const INFO_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.ZKSYNC_TESTNET]: 'https://api.studio.thegraph.com/query/45376/exchange-v2-zksync-testnet/latest',
...
export const V3_SUBGRAPH_URLS = {
  ...
  [ChainId.ZKSYNC]: null,
  [ChainId.ZKSYNC_TESTNET]: 'https://api.studio.thegraph.com/query/45376/exchange-v3-zksync-testnet/latest',
